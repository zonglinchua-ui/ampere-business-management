...
export default function DraftProgressClaimInvoicesPage() {
  ...
  const [summary, setSummary] = useState({ totalInvoices: 0, totalAmount: 0, currency: 'SGD' })
  ...
  const fetchInvoices = async () => {
    try {
      setLoading(true)
      const response = await fetch('/api/finance/draft-progress-claim-invoices')
      ...
      if (data.success) {
        ...
        setSummary(data.summary || { totalInvoices: 0, totalAmount: 0, currency: 'SGD' })
        console.log(`✅ Loaded ${data.invoices?.length || 0} draft progress claim invoices`)
      } else {
  ...
  const handleBatchSync = async () => {
    ...
    try {
      setSyncing(true)
      const response = await fetch('/api/finance/draft-progress-claim-invoices/batch-sync', {
        method: 'POST',
        headers: {
  ...
  const handleInvoiceClick = (invoiceId: string) => {
    router.push(`/finance/customer-invoices/${invoiceId}`)
  }
      ...
      <MainLayout>
        <div className="flex items-center justify-center min-h-screen">
          <div className="text-center">
            ...
            <p className="text-gray-600 mt-2">You don't have permission to access draft progress claim invoices.</p>
          </div>
        </div>
      </MainLayout>
    )
      ...
      <div className="p-6">
        ...
        <div className="flex items-center justify-between mb-6">
          <div className="flex items-center space-x-4">
            ...
            <div>
              <h1 className="text-2xl font-bold text-gray-900">Draft Progress Claim Invoices</h1>
              <p className="text-gray-600">Review and batch sync invoices to Xero</p>
            </div>
          </div>
            ...
            <CardContent className="p-4">
              <div className="flex items-center space-x-2">
                ...
                <div>
                  ...
                  <p className="text-2xl font-bold">{selectedInvoices.size}</p>
              ...
              <div className="flex items-start space-x-3">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-sm text-blue-700 mt-1">
                    These draft invoices were automatically created from approved progress claims. 
                    Please review the details carefully before batch syncing them to Xero.
                  </p>
                </div>
              </div>
            </CardContent>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Invoices awaiting sync to Xero
            </CardDescription>
          </CardHeader>
          <CardContent>
            {invoices.length === 0 ? (
              <div className="text-center py-12">
                ...
                <h3 className="text-lg font-medium text-gray-900 mb-2">No Draft Invoices</h3>
                <p className="text-gray-500">
                  All progress claim invoices have been synced to Xero. Great job!
                </p>
              </div>
            ) : (
                    ...
                    {invoices.map((invoice) => (
                      ...
                      >
                        ...
                        <TableCell className="text-right font-semibold">
                          {formatCurrency(parseFloat(invoice.totalAmount.toString()), invoice.currency)}
                        </TableCell>
                        <TableCell>
                          <div className="flex items-center space-x-2">
            ...
            <AlertDialogHeader>
              ...
              <AlertDialogDescription className="space-y-2">
                ...
                <p className="text-yellow-700">
                  ⚠️ This action will push these invoices to Xero as DRAFT invoices. Please ensure all details are correct.
                </p>
              </AlertDialogDescription>
            </AlertDialogHeader>
            <AlertDialogFooter>
