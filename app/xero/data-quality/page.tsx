...
export default function XeroDataQualityPage() {
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
            <Card>
              <CardHeader className="pb-2">
                ...
                <CardTitle className="text-3xl">{stats.totalErrors}</CardTitle>
              </CardHeader>
            </Card>
            <Card>
              <CardHeader className="pb-2">
                <CardDescription>Unresolved</CardDescription>
                <CardTitle className="text-3xl text-red-600">{stats.unresolvedErrors}</CardTitle>
              </CardHeader>
            </Card>
            <Card>
              <CardHeader className="pb-2">
                <CardDescription>Recent (24h)</CardDescription>
                <CardTitle className="text-3xl text-yellow-600">{stats.recentErrors}</CardTitle>
              </CardHeader>
            </Card>
            <Card>
              <CardHeader className="pb-2">
                <CardDescription>Duplicate Groups</CardDescription>
                <CardTitle className="text-3xl text-orange-600">{duplicates.length}</CardTitle>
              </CardHeader>
            </Card>
          </div>
        )}
