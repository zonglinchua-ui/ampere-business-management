...
export const DEFAULT_TEMPLATES: DocumentTemplate[] = [
  ...
  {
    id: 'progress-claim-template',
    name: 'Progress Claim',
    templateType: 'PROGRESS_CLAIM',
    category: 'CONSTRUCTION',
    description: 'Progress payment claim for completed works during construction',
    fields: [
      { id: 'project-id', label: 'Project ID', type: 'text', required: true, placeholder: 'AMP-YYYY-XXX' },
      { id: 'project-name', label: 'Project Name', type: 'text', required: true },
      { id: 'client-name', label: 'Client Name', type: 'text', required: true },
      { id: 'client-address', label: 'Client Address', type: 'textarea', required: true },
      { id: 'claim-reference-number', label: 'Claim Reference Number', type: 'text', required: true, placeholder: 'PC-XXX' },
      { id: 'claim-date', label: 'Claim Date', type: 'date', required: true },
      { id: 'claim-period-from', label: 'Claim Period From', type: 'date', required: true },
      { id: 'claim-period-to', label: 'Claim Period To', type: 'date', required: true },
      { id: 'contract-value', label: 'Total Contract Value', type: 'number', required: true, placeholder: 'SGD' },
      { id: 'work-completed-description', label: 'Work Completed Description', type: 'textarea', required: true, placeholder: 'Detailed breakdown of completed works' },
      { id: 'work-breakdown', label: 'Breakdown of Completed Works', type: 'textarea', required: true, placeholder: 'Itemized list with quantities and values' },
      { id: 'percentage-completion', label: 'Percentage of Completion', type: 'number', required: true, placeholder: '0-100' },
      { id: 'amount-claimed-this-period', label: 'Amount Claimed for this Period', type: 'number', required: true, placeholder: 'SGD' },
      { id: 'cumulative-amount-claimed', label: 'Cumulative Amount Claimed', type: 'number', required: true, placeholder: 'SGD' },
      { id: 'previous-payments-made', label: 'Previous Payments Made', type: 'number', required: true, placeholder: 'SGD' },
      { id: 'retention-amount', label: 'Retention Amount', type: 'number', placeholder: 'SGD (if applicable)' },
      { id: 'retention-percentage', label: 'Retention Percentage', type: 'number', placeholder: '% (if applicable)' },
      { id: 'balance-remaining', label: 'Balance Remaining', type: 'number', required: true, placeholder: 'SGD' },
      { id: 'variations-included', label: 'Variations Included', type: 'textarea', placeholder: 'List any approved variations' },
      { id: 'materials-on-site', label: 'Materials on Site', type: 'textarea', placeholder: 'Value of materials delivered but not yet installed' },
      { id: 'supporting-documents', label: 'Supporting Documents', type: 'textarea', placeholder: 'List of attached supporting documents' },
      { id: 'payment-terms', label: 'Payment Terms', type: 'text', required: true, placeholder: 'e.g., 30 days from claim date' },
      { id: 'certification-notes', label: 'Certification Notes', type: 'textarea', placeholder: 'Additional notes or conditions' },
      { id: 'prepared-by', label: 'Prepared By', type: 'text', required: true },
      { id: 'prepared-date', label: 'Prepared Date', type: 'date', required: true },
      { id: 'reviewed-by', label: 'Reviewed By (Project Manager)', type: 'text' },
      { id: 'reviewed-date', label: 'Review Date', type: 'date' },
      { id: 'certified-by', label: 'Certified By (Authorized Signatory)', type: 'text' },
      { id: 'certification-date', label: 'Certification Date', type: 'date' },
      { id: 'client-approval-by', label: 'Client Approval By', type: 'text' },
      { id: 'client-approval-date', label: 'Client Approval Date', type: 'date' }
    ],
    sections: [
      { title: 'Project Information', fields: ['project-id', 'project-name', 'client-name', 'client-address'] },
      { title: 'Claim Details', fields: ['claim-reference-number', 'claim-date', 'claim-period-from', 'claim-period-to', 'contract-value'] },
      { title: 'Work Description', fields: ['work-completed-description', 'work-breakdown', 'percentage-completion'] },
      { title: 'Financial Summary', fields: ['amount-claimed-this-period', 'cumulative-amount-claimed', 'previous-payments-made', 'retention-amount', 'retention-percentage', 'balance-remaining'] },
      { title: 'Additional Information', fields: ['variations-included', 'materials-on-site', 'supporting-documents', 'payment-terms', 'certification-notes'] },
      { title: 'Certification & Approval', fields: ['prepared-by', 'prepared-date', 'reviewed-by', 'reviewed-date', 'certified-by', 'certification-date', 'client-approval-by', 'client-approval-date'] }
    ]
  },
  ...
  {
    id: 'delivery-order-job-completion-template',
    name: 'Delivery Order / Job Completion',
    templateType: 'DELIVERY_ORDER_JOB_COMPLETION',
    category: 'HANDOVER_COMPLETION',
    description: 'Comprehensive delivery order and job completion documentation',
    fields: [
      { id: 'delivery-order-number', label: 'Delivery Order Number', type: 'text', required: true, placeholder: 'DO-YYYY-XXX' },
      { id: 'project-name', label: 'Project Name', type: 'text', required: true },
      { id: 'client-name', label: 'Client Name', type: 'text', required: true },
      { id: 'client-address', label: 'Client Address', type: 'textarea', required: true },
      { id: 'delivery-date', label: 'Delivery Date', type: 'date', required: true },
      { id: 'completion-date', label: 'Job Completion Date', type: 'date', required: true },
      { id: 'project-manager', label: 'Project Manager', type: 'text', required: true },
      { id: 'delivery-supervisor', label: 'Delivery Supervisor', type: 'text', required: true },
      { id: 'work-scope-summary', label: 'Work Scope Summary', type: 'textarea', required: true, placeholder: 'Brief description of completed work' },
      { id: 'deliverables-list', label: 'Deliverables List', type: 'textarea', required: true, placeholder: 'List all items being delivered' },
      { id: 'materials-delivered', label: 'Materials / Equipment Delivered', type: 'textarea', required: true },
      { id: 'quantities-delivered', label: 'Quantities Delivered', type: 'textarea', required: true, placeholder: 'Specify quantities for each item' },
      { id: 'installation-location', label: 'Installation / Delivery Location', type: 'text', required: true },
      { id: 'quality-inspection-status', label: 'Quality Inspection Status', type: 'select', required: true, options: ['Passed', 'Passed with Minor Issues', 'Conditional Pass', 'Failed'] },
      { id: 'testing-results', label: 'Testing Results', type: 'textarea', placeholder: 'Results of any testing performed' },
      { id: 'commissioning-status', label: 'Commissioning Status', type: 'select', options: ['Completed', 'Partial', 'Not Applicable', 'Pending'] },
      { id: 'safety-compliance', label: 'Safety Compliance Verified', type: 'checkbox', required: true },
      { id: 'regulatory-compliance', label: 'Regulatory Compliance Met', type: 'checkbox', required: true },
      { id: 'client-training-provided', label: 'Client Training Provided', type: 'checkbox' },
      { id: 'operation-manual-provided', label: 'Operation Manual Provided', type: 'checkbox' },
      { id: 'warranty-information', label: 'Warranty Information', type: 'textarea', required: true, placeholder: 'Warranty period and coverage details' },
      { id: 'maintenance-schedule', label: 'Maintenance Schedule', type: 'textarea', placeholder: 'Recommended maintenance schedule' },
      { id: 'outstanding-items', label: 'Outstanding Items', type: 'textarea', placeholder: 'Any remaining work or issues' },
      { id: 'special-instructions', label: 'Special Instructions', type: 'textarea', placeholder: 'Any special handling or operational instructions' },
      { id: 'environmental-considerations', label: 'Environmental Considerations', type: 'textarea', placeholder: 'Environmental impact and mitigation measures' },
      { id: 'health-safety-requirements', label: 'Health & Safety Requirements', type: 'textarea', placeholder: 'Ongoing H&S requirements for client' },
      { id: 'client-representative', label: 'Client Representative', type: 'text', required: true },
      { id: 'client-signature-date', label: 'Client Signature Date', type: 'date' },
      { id: 'client-satisfaction-rating', label: 'Client Satisfaction Rating', type: 'select', options: ['Excellent', 'Very Good', 'Good', 'Satisfactory', 'Needs Improvement'] },
      { id: 'client-feedback', label: 'Client Feedback', type: 'textarea' },
      { id: 'contractor-representative', label: 'Contractor Representative', type: 'text', required: true },
      { id: 'contractor-signature-date', label: 'Contractor Signature Date', type: 'date', required: true },
      { id: 'photos-attached', label: 'Completion Photos Attached', type: 'checkbox' },
      { id: 'certificates-attached', label: 'Certificates Attached', type: 'checkbox' },
      { id: 'delivery-receipt-number', label: 'Delivery Receipt Number', type: 'text', placeholder: 'Reference number for delivery receipt' }
    ],
    sections: [
      { title: 'Delivery Information', fields: ['delivery-order-number', 'project-name', 'client-name', 'client-address', 'delivery-date', 'completion-date'] },
      { title: 'Personnel', fields: ['project-manager', 'delivery-supervisor', 'client-representative', 'contractor-representative'] },
      { title: 'Work Summary', fields: ['work-scope-summary', 'deliverables-list', 'materials-delivered', 'quantities-delivered', 'installation-location'] },
      { title: 'Quality & Compliance', fields: ['quality-inspection-status', 'testing-results', 'commissioning-status', 'safety-compliance', 'regulatory-compliance'] },
      { title: 'Documentation & Training', fields: ['client-training-provided', 'operation-manual-provided', 'warranty-information', 'maintenance-schedule'] },
      { title: 'Outstanding & Special Items', fields: ['outstanding-items', 'special-instructions', 'environmental-considerations', 'health-safety-requirements'] },
      { title: 'Client Acceptance', fields: ['client-signature-date', 'client-satisfaction-rating', 'client-feedback'] },
      { title: 'Completion & Attachments', fields: ['contractor-signature-date', 'photos-attached', 'certificates-attached', 'delivery-receipt-number'] }
    ]
  },
...
export function generateQuotationHTML(data: any): string {
  ...
  const salesperson = data.User_Quotation_salespersonIdToUser || {}
  const items = data.QuotationItem || []
  ...
  // Apply GST (7% for Singapore)
  if (data.gstApplicable !== false) {
    gstAmount = subtotal * 0.07
  }
  ...
  return `
    ...
    <html lang="en">
      <head>
        ...
        <title>Quotation ${data.quotationNumber} - Ampere Engineering</title>
        <style>
          /* Professional Document Styling - Ampere Branding */
          * {
            margin: 0;
            padding: 0;
          ...
          /* PROFESSIONAL LETTERHEAD - Ampere Branding */
          .letterhead-header {
            display: flex;
          ...
          .company-logo {
            width: 120px;
            height: 80px;
            background-image: url('/Uploads/ampere_2017%20(2).png');
          ...
          .bca-logo {
            background-image: url('/logos/bca_registered_contractor_official.png');
          }

          .ies-logo {
            background-image: url('/logos/ies_singapore_official.png');
          }

          .peb-logo {
            background-image: url('/logos/peb_official_logo.png');
          }
          ...
          /* Terms and Conditions - Fixed spacing */
          .terms-section {
            margin-top: 30px;
            margin-bottom: 40px;
            padding: 15px 20px;
          ...
          /* Print Optimization - Clean version */
          @media print {
            .document-container {
              margin: 0;
        ...
        <div class="document-container">
          ...
          <div class="letterhead-header">
            ...
            <div class="company-info-section">
              <div class="company-tagline" style="margin-bottom: 25px;">Excellence in Engineering Solutions</div>
              <div class="company-contact-info">
                <div class="company-details">
                  <div class="detail-line">101 Upper Cross Street, #04-05 People's Park Centre</div>
                  <div class="detail-line">Singapore 058357</div>
                  <div class="contact-line">
                    <strong>Tel:</strong> +65 6677 8457
                    <span class="separator">|</span>
                    <strong>Fax:</strong> +65 6677 8458
                  </div>
                  <div class="contact-line">
                    <strong>Email:</strong> projects@ampere.com.sg
                  </div>
                  <div class="contact-line">
                    <strong>GST Reg No:</strong> 201021612W
                  </div>
                </div>
              </div>
            </div>
            ...
            <div class="accreditations-section">
              <div class="accreditation-title">Accreditations</div>
              <div class="accreditation-logos">
                <div class="accreditation-item">
                  <div class="accreditation-logo bca-logo"></div>
                  <div class="accreditation-text">BCA<br/>Registered</div>
                </div>
                <div class="accreditation-item">
                  <div class="accreditation-logo ies-logo"></div>
                  <div class="accreditation-text">IES<br/>Singapore</div>
                </div>
              </div>
              <div style="margin-top: 8px;">
                <div class="accreditation-item">
                  <div class="accreditation-logo peb-logo"></div>
                  <div class="accreditation-text">PEB<br/>Licensed</div>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="document-header">
            <div class="document-title-section">
              ...
              <div class="document-meta">
                <div>Document No: <span class="emphasis">${data.quotationNumber}</span></div>
                <div>Date: <span class="emphasis">${formatDate(new Date(data.createdAt || Date.now()))}</span></div>
              </div>
            </div>
          </div>
          ...
          <div class="content-section">
            <div class="info-grid">
              <div class="info-box">
                ...
                <div class="info-line"><span class="label">Company:</span> ${customer.name || 'Please enter client company name'}</div>
                <div class="info-line"><span class="label">Contact:</span> ${customer.contactPerson || 'Please enter contact person'}</div>
                <div class="info-line"><span class="label">Email:</span> ${customer.email || 'Please enter client email'}</div>
                <div class="info-line"><span class="label">Phone:</span> ${customer.phone || 'Please enter client phone'}</div>
                <div class="info-line"><span class="label">Address:</span> ${customer.address || 'Please enter client address'}</div>
              </div>
              
              <div style="padding: 18px; background: none; border: none; border-radius: 0; box-shadow: none;">
                <div style="margin-bottom: 12px; font-size: 15px; font-weight: bold; color: #1e40af; text-transform: uppercase; letter-spacing: 0.5px;">Project Details</div>
                <div class="info-line"><span class="label">RE:</span> ${data.title || 'N/A'}</div>
                <div class="info-line"><span class="label">Description:</span> ${data.description || 'N/A'}</div>
                <div class="info-line"><span class="label">Salesperson:</span> ${salesperson.firstName || ''} ${salesperson.lastName || 'N/A'}</div>
                <div class="info-line"><span class="label">Email:</span> ${salesperson.email || 'N/A'}</div>
                <div class="info-line"><span class="label">Valid Until:</span> ${data.validUntil ? formatDate(new Date(data.validUntil)) : 'N/A'}</div>
              </div>
            </div>
          </div>
                  ...
                  if (item.type === 'SECTION') {
                    return `
                      <tr class="section-row">
                        <td colspan="6" style="padding: 12px 8px; font-weight: bold;">
                          ${item.description || `Section ${index + 1}`}
                        </td>
                      </tr>
                    `
                  } else {
                    return `
                      <tr>
                        <td class="text-center">${item.order || index + 1}</td>
                        <td>${item.description || 'N/A'}</td>
                        <td class="text-center">${item.quantity || 0}</td>
                        <td class="text-center">${item.unit || 'unit'}</td>
                        <td class="text-right">${formatCurrency(parseFloat(item.unitPrice || 0))}</td>
                        <td class="text-right">${formatCurrency(parseFloat(item.totalPrice || 0))}</td>
                      </tr>
                    `
                  }
                }).join('')}
          ...
          <div class="financial-summary">
            <table class="summary-table">
              <tr>
                ...
                <td class="amount-col">${formatCurrency(subtotal)}</td>
              </tr>
              ${gstAmount > 0 ? `
                <tr>
                  <td class="label-col">GST (7%):</td>
                  <td class="amount-col">${formatCurrency(gstAmount)}</td>
                </tr>
              ` : ''}
              <tr class="total-row">
                <td>TOTAL AMOUNT:</td>
          ...
          <div class="content-section">
            <div class="terms-section">
              ...
              <ol class="terms-list">
                <li><strong>Quotation Validity:</strong> This quotation is valid until ${data.validUntil ? formatDate(new Date(data.validUntil)) : '30 days from quotation date'}.</li>
                <li><strong>Payment Terms:</strong> ${data.paymentTerms || '50% deposit upon order confirmation, 50% balance upon completion'}.</li>
                <li><strong>Currency & GST:</strong> All prices are in Singapore Dollars (SGD) and ${gstAmount > 0 ? 'inclusive of 9% GST unless otherwise stated' : 'GST may be applicable as per prevailing rates'}.</li>
                <li><strong>Scope Variations:</strong> Any variations to the original scope of work will be charged separately.</li>
                <li><strong>Working Hours:</strong> Work will be carried out during normal business hours, excluding weekends and public holidays.</li>
                <li><strong>Payment Condition:</strong> The company reserves the right to withhold services until payment is received.</li>
                <li><strong>Compliance:</strong> All work will be carried out in accordance with relevant codes and safety regulations.</li>
                <li><strong>Contract Binding:</strong> This quotation becomes a binding contract upon written acceptance by the customer.</li>
              </ol>
            </div>
          </div>

          <!-- Document Footer with Company Info -->
          <div class="document-footer">
            <div class="footer-company">AMPERE ENGINEERING PTE LTD</div>
            <div class="footer-tagline">Excellence in Engineering Solutions</div>
            <div class="footer-disclaimer">
              <p><strong>CONFIDENTIAL DOCUMENT</strong> - This document contains proprietary information and is intended solely for the use of the addressee.</p>
...
export function generatePurchaseOrderHTML(data: any): string {
  ...
  // Get supplier/vendor and project information
  const vendor = data.Supplier || data.Vendor || data.supplier || {}
  const project = data.Project || data.project || {}
  const requester = data.User_PurchaseOrder_requesterIdToUser || data.requester || {}
  ...
  return `
    ...
    <html lang="en">
      <head>
        <meta charset="UTF-8">
        <meta name="viewport" content="width=device-width, initial-scale=1.0">
        <title>Purchase Order ${data.poNumber} - Ampere Engineering</title>
        <style>
          /* Professional Document Styling - Standardized Format */
          * {
            margin: 0;
            padding: 0;
            box-sizing: border-box;
          ...
          /* LETTERHEAD STYLING - Standardized */
          .letterhead-header {
            display: flex;
            align-items: flex-start;
            padding: 20px 0;
      ...
      <body>
        <div class="document-container">
          ...
          <div class="letterhead-header">
            ...
            <div class="company-info-section">
              <h1 class="company-name">AMPERE ENGINEERING PTE LTD</h1>
              <div class="company-tagline">Professional Engineering Solutions</div>
              <div class="company-details">
                <div class="detail-line">101 Upper Cross Street, #04-05 People's Park Centre, Singapore 058357</div>
                <div class="contact-line">
                  <span>email: projects@ampere.com.sg</span>
                  <span class="separator">|</span>
                  <span>tel: +65 6677 8457</span>
                </div>
                <div class="contact-line">
                  <span>Business/GST Registration No: 201021612W</span>
                </div>
              </div>
            </div>

            <div class="company-certs-section">
              <div class="cert-item">
                <div class="cert-badge">ISO</div>
                <div class="cert-text">9001:2015</div>
              </div>
              <div class="cert-item">
                <div class="cert-badge">BIZSAFE</div>
                <div class="cert-text">Level 3</div>
              </div>
            </div>
          </div>
          ...
          <div class="letterhead-divider">
            ...
            <div class="divider-line secondary"></div>
          </div>
          ...
          <div class="document-header">
            <div class="document-title-section">
              ...
              <div class="document-meta">
                <div>Document No: <span class="emphasis">${data.poNumber}</span></div>
                <div>Date: <span class="emphasis">${formatDate(new Date(data.createdAt || Date.now()))}</span></div>
              </div>
            </div>
          </div>
          ...
          <div class="content-section">
            <div class="info-grid">
              <div class="info-box">
                ...
                <div class="info-line"><span class="label">Company:</span> ${vendor.companyName || vendor.name || 'N/A'}</div>
                <div class="info-line"><span class="label">Contact:</span> ${vendor.name || vendor.contactPerson || 'N/A'}</div>
                <div class="info-line"><span class="label">Email:</span> ${vendor.email || 'N/A'}</div>
                <div class="info-line"><span class="label">Phone:</span> ${vendor.phone || 'N/A'}</div>
                <div class="info-line"><span class="label">Address:</span> ${vendor.address || 'N/A'}</div>
              </div>
              
              <div class="info-box">
                <h3>Project Information</h3>
                <div class="info-line"><span class="label">Project:</span> ${project.name || 'N/A'}</div>
                <div class="info-line"><span class="label">Project No:</span> ${project.projectNumber || 'N/A'}</div>
                <div class="info-line"><span class="label">Requested By:</span> ${requester.firstName || ''} ${requester.lastName || 'N/A'}</div>
                <div class="info-line"><span class="label">Email:</span> ${requester.email || 'N/A'}</div>
                <div class="info-line"><span class="label">Delivery Date:</span> ${data.expectedDelivery ? formatDate(new Date(data.expectedDelivery)) : 'N/A'}</div>
              </div>
            </div>
          </div>
          ...
          <div class="content-section">
            <div class="section-header">Purchase Order Items</div>
            <table class="items-table">
              <thead>
                <tr>
                  <th style="width: 5%">#</th>
          ...
          <div class="terms-section">
            ...
            <ol class="terms-list">
              <li><strong>Delivery:</strong> Delivery must be made by ${data.expectedDelivery ? formatDate(new Date(data.expectedDelivery)) : 'agreed delivery date'} to the specified delivery address.</li>
              <li><strong>Payment Terms:</strong> ${data.paymentTerms || '30 days net from invoice date'}.</li>
              <li><strong>Quality:</strong> All goods must comply with specified quality standards and be in good condition upon delivery.</li>
              <li><strong>Invoice:</strong> Invoice should reference this PO number (${data.poNumber}) for payment processing.</li>
              <li><strong>Changes:</strong> Any changes to this order must be approved in writing by the authorized representative.</li>
              <li><strong>Acceptance:</strong> Goods are subject to inspection and acceptance by the purchaser.</li>
              <li><strong>Delivery Address:</strong> Unless otherwise specified, deliver to site address or company address.</li>
              <li><strong>Compliance:</strong> Vendor must comply with all applicable safety and regulatory requirements.</li>
            </ol>
          </div>
          ...
          <div class="document-footer">
            <div class="footer-company">AMPERE ENGINEERING PTE LTD</div>
            <div class="footer-tagline">Your Trusted Engineering Partner</div>
            <div class="footer-disclaimer">
...
export function generateJobCompletionHTML(data: any): string {
  ...
  const certificateNumber = data.certificateNumber || `JCC-${new Date().getFullYear()}-${String(Date.now()).slice(-6)}`
  ...
  return `
    ...
    <html lang="en">
      <head>
        <meta charset="UTF-8">
        <meta name="viewport" content="width=device-width, initial-scale=1.0">
        <title>Job Completion Certificate ${certificateNumber} - Ampere Engineering</title>
        <style>
          /* Professional Document Styling - Standardized Format */
          * {
            margin: 0;
          ...
          .certificate-notice .cert-number {
            font-weight: bold;
            color: #dc2626;
          }
      ...
      <body>
        <div class="document-container">
          ...
          <div class="document-header">
            <div class="document-title-section">
              <h2 class="document-title">JOB COMPLETION CERTIFICATE</h2>
              <div class="document-meta">
                <div>Certificate No: <span class="emphasis">${certificateNumber}</span></div>
                <div>Date: <span class="emphasis">${formatDate(new Date())}</span></div>
              </div>
            </div>
          </div>
          ...
          <div class="content-section">
            <div class="info-grid">
              <div class="info-box">
                <h3>Client Information</h3>
                <div class="info-line"><span class="label">Client Name:</span> ${data.clientName || 'N/A'}</div>
                <div class="info-line"><span class="label">Project:</span> ${data.projectName || 'N/A'}</div>
                <div class="info-line"><span class="label">Location:</span> ${data.location || 'N/A'}</div>
                <div class="info-line"><span class="label">Contact:</span> ${data.clientContact || 'N/A'}</div>
              </div>
              
              <div class="info-box">
                <h3>Service Details</h3>
                <div class="info-line"><span class="label">Service Type:</span> ${data.serviceType || 'N/A'}</div>
                <div class="info-line"><span class="label">Scheduled Date:</span> ${data.scheduledDate ? formatDate(data.scheduledDate) : 'N/A'}</div>
                <div class="info-line"><span class="label">Completion Date:</span> ${data.completionDate ? formatDate(data.completionDate) : 'N/A'}</div>
                <div class="info-line"><span class="label">Duration:</span> ${data.duration || 'N/A'}</div>
                <div class="info-line"><span class="label">Assigned To:</span> ${data.assignedUserName || 'N/A'}</div>
              </div>
            </div>
          </div>
          ...
          <div class="work-details">
            ...
            <p>${data.completionNotes || 'All work has been completed as per the service requirements and specifications. The job was executed according to industry standards and client expectations.'}</p>
            
            ${data.workScope ? `
              <h4 style="color: #dc2626; margin-top: 20px; margin-bottom: 10px;">Scope of Work:</h4>
              <p>${data.workScope}</p>
            ` : ''}
            
            ${data.materialsUsed ? `
              <h4 style="color: #dc2626; margin-top: 20px; margin-bottom: 10px;">Materials/Equipment Used:</h4>
              <p>${data.materialsUsed}</p>
            ` : ''}
            
            ${data.testingResults ? `
              <h4 style="color: #dc2626; margin-top: 20px; margin-bottom: 10px;">Testing Results:</h4>
              <p>${data.testingResults}</p>
            ` : ''}
          </div>

          <!-- Certificate Notice -->
          <div class="certificate-notice">
            <p>This certificate confirms that the above-mentioned work has been completed satisfactorily</p>
            <p>in accordance with the agreed specifications and industry standards.</p>
            <p>Certificate Number: <span class="cert-number">${certificateNumber}</span></p>
          </div>
          ...
          <div class="signatures-section">
            <div class="signature-box">
              ...
              <div class="signature-name">${data.assignedUserName || 'Authorized Representative'}</div>
              <div class="signature-role">${data.assignedUserRole || 'Project Engineer'}</div>
            ...
            <div class="signature-box">
              ...
              <div class="signature-name">${data.clientName || 'Client Representative'}</div>
          ...
          <div class="document-footer">
            ...
            <div class="footer-tagline">Your Trusted Engineering Partner</div>
            <div class="footer-disclaimer">
              <p>This certificate is computer generated and serves as official documentation of work completion.</p>
              <p>For verification, please contact us at +65 6677 8457 or projects@ampere.com.sg</p>
            </div>
          </div>
        </div>
      </body>
